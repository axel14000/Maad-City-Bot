...
client.on('message', async message => {
    ...
    client.on("guildMemberAdd", function(member) {
        member.guild.channels.find("name", "annonce").sendMessage(" Bienvenue sur mon serveur " + member.toString());
        member.addRole(member.guild.roles.find("name", "Test"));
    });
    
    client.on("guildMemberRemove", function(member) {
        member.guild.channels.find("name", "annonce").sendMessage( member.toString() + "Nous a quitté ! ");
    });
